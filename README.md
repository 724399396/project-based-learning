...
- [x] [Build an Interpreter](http://www.craftinginterpreters.com/) (Chapter 14 on is written in C)
...
- [X] [Write a FUSE Filesystem](https://www.cs.nmsu.edu/~pfeiffer/fuse-tutorial/)
...
- [X] [Building a CHIP-8 Emulator](https://austinmorlan.com/posts/chip8_emulator/)
- [ ] [Beginning Game Programming with C++ and SDL](http://lazyfoo.net/tutorials/SDL/) (lesson 20)
- [ ] [Implementing a Key-Value Store](http://codecapsule.com/2012/11/07/ikvs-implementing-a-key-value-store-table-of-contents/) (chapter 4)
...
- Writing a minimal x86-64 JIT compiler in C++
  - [X] [Part 1](https://solarianprogrammer.com/2018/01/10/writing-minimal-x86-64-jit-compiler-cpp/)
  - [X] [Part 2](https://solarianprogrammer.com/2018/01/12/writing-minimal-x86-64-jit-compiler-cpp-part-2/)
- [X] [Build a Live Code-reloader Library for C++](http://howistart.org/posts/cpp/1/index.html)
- [X] [Write a hash table in C](https://github.com/jamesroutley/write-a-hash-table)
- [X] [Let's Build a Simple Database](https://cstack.github.io/db_tutorial/)
- [X] [Let's Write a Kernel](http://arjunsreedharan.org/post/82710718100/kernel-101-lets-write-a-kernel)
...
- [X] [Write Your Own Virtual Machine](https://justinmeiners.github.io/lc3-vm/)
...
-  [x] Programming concurrent servers
...
- [x] [Build a Twitter Bot with Clojure](http://howistart.org/posts/clojure/1/index.html)
- [x] [Building a Spell-Checker](https://bernhardwenzel.com/articles/clojure-spellchecker/)
...
- [x] [Building a Simple Chat App With Elixir and Phoenix](https://sheharyar.me/blog/simple-chat-phoenix-elixir/)
...
- [x] [Build a Simple HTTP Server with Java](http://javarevisited.blogspot.com/2015/06/how-to-create-http-server-in-java-serversocket-example.html)
...
- [x] [Build an App in Pure JS](https://medium.com/codingthesmartway-com-blog/pure-javascript-building-a-real-world-application-from-scratch-5213591cfcd6)
...
- [x] [Build A Loading Screen](https://medium.freecodecamp.org/how-to-build-a-delightful-loading-screen-in-5-minutes-847991da509f)
- [x] [Build an HTML Calculator with JS](https://medium.freecodecamp.org/how-to-build-an-html-calculator-app-from-scratch-using-javascript-4454b8714b98)
...
- [ ] [Vue.js Application Tutorial – Creating a Simple Budgeting App with Vue](https://matthiashager.com/complete-vuejs-application-tutorial/) # too old not complete
...
- [x] [Build Yourself a Redux](https://zapier.com/engineering/how-to-build-redux/)
- [x] [How to write your own Virtual DOM](https://medium.com/@deathmood/how-to-write-your-own-virtual-dom-ee74acc13060)
...
- [x] [Scrape a Website with Scrapy and MongoDB](https://realpython.com/blog/python/web-scraping-with-scrapy-and-mongodb/)
...
- [x] [Build a RESTful API with Flask – The TDD Way](https://scotch.io/tutorials/build-a-restful-api-with-flask-the-tdd-way)
...
- [x] [Step-By-Step Machine Learning In Python](https://machinelearningmastery.com/machine-learning-in-python-step-by-step/)
